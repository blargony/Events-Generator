...
class calc:
    ...
    def __init__(self, year):
        ...
        next_phase = {
            ...
            RuleLunar.moon_3q: (ephem.next_last_quarter_moon,
                                '3rd Qtr moon', RuleLunar.moon_new)
        }
        y = year - 1
        next_year = year + 1
        ...
        astro_events += cal_opp.calc_planets(year)
        astro_events.sort()
...
#   MOON.compute('2016/2/28')
    ...
    if date <= time_moonset < date + HOUR*12:
        ...
        time_moonrise = TZ_LOCAL.localize(
            ephem.localtime(local.next_rising(MOON)))
